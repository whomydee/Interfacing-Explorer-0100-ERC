...
public class Volt extends ApplicationFrame implements ActionListener{
    ...
    public Volt(String title) throws IOException {
        ...
        */
        ...
        final JTextField ip = new JTextField("192.168.1.12");
                ...
                if(connection == false){
                    ...
                    try {
                        ...
                        log.setText(log.getText().toString() + "Connection Has Been Established with IP: " + given_ip + "\n");
                            ...
                            Logger.getLogger(Volt.class.getName()).log(Level.SEVERE, null, ex);
                     }
  ...
  //set minimum and maximum value
    ...
    double value_next;
    if(volt == 0.0) value_next = volt;
    else value_next = volt + 1;
    
    meterplot.setRange(new Range(0.0D, 220.0D));

    meterplot.addInterval(new MeterInterval("Current Voltage", new Range(0.0D, volt), Color.blue, new BasicStroke(2.0F), new Color(255, 0, 0, 128)));

    meterplot.addInterval(new MeterInterval("High Voltage", new Range(110.0D, 220.0D), Color.blue, new BasicStroke(2.0F), new Color(255, 255, 0, 64)));
    ...
    JFreeChart jfreechart = new JFreeChart("Voltage Reading", JFreeChart.DEFAULT_TITLE_FONT, meterplot, true);
...
public void update(){
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       //Receive Data Packet
          ...
          try{
                 ...
                 volt = Float.valueOf(data[0]);
                 //humidity = Float.valueOf(data[1]);
                 //humidity = Float.valueOf(data[2]);
                       
                 update();
                 
                 log.setText(log.getText().toString() + "Voltage Reading: " + volt + "\n");
    ...
    public static void main(String[] args) throws IOException {
        ...
        Volt demo = new Volt("Team Mongol Barota 2015");
        demo.pack();
